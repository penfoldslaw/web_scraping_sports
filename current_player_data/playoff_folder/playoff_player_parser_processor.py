...
def run_script(relative_path, csv_path):
    ...
    subprocess.run([sys.executable,path / "playoff_parser.py", relative_path, csv_path])
...
if __name__ == "__main__":
    ...
    for season in seasons:
        relative_path = [
            r"D:\nba_player_current\nba_html_{season}_playoff".format(season=season)
        ...
        csv_path = [
            r"D:\nba_player_csv_current\season_{season}_playoff\all_quarters".format(season=season)
