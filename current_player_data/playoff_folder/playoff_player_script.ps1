...
$scriptPath = Join-Path -Path $scriptDir "playoff_player_scraper_processor.py"  # Replace with your actual script path
$scriptPath_parser = Join-Path -Path $scriptDir "playoff_player_parser_processor.py"
