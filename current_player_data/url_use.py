from url_scraper_function import nba_player_scraper, prepend_csv_files
import os
import subprocess
import sys
...
log_file_path = "current_logs/current_player_url.log"
