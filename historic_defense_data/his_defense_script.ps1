...
$scriptPath = Join-Path -Path $scriptDir "his_defense_scarper_processor.py"  # Replace with your actual script path
$scriptPath_parser = Join-Path -Path $scriptDir "his_defense_parser_processor.py"
