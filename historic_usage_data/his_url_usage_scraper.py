...
def replace_regular_w_playin_or_playoff(regular_season_csv_path, playin_or_playoff_csv_path,season):
    """
    ...
    for filename in csv_files:
        ...
        playin_csv_path = os.path.join(playin_or_playoff_csv_path, f'nba_csv_{season}', filename)
